...
class test_cases(unittest.TestCase):
    ...
    def test_Dot_Product(self):
        test_vector1 = data.Vector(1,2,3)
        test_vector2 = data.Vector(4,5,6)
        self.assertEqual(vector_math.dot_vector(test_vector1,test_vector2,),data.Vector(4,10,18))

        test_vector1 = data.Vector(2, 1, 8)
        test_vector2 = data.Vector(5, 2, 1)
        self.assertEqual(vector_math.dot_vector(test_vector1, test_vector2, ), data.Vector(10, 2, 8))
